...
export default function Popular() {
    ...
    useEffect(() => {
        (async () => {
            const response = await fetch(`${API_URL}/popular?api_key=${API_KEY}&language=${API_LANG}&page=${page}`);
        ...
        <Fragment>
            <Row style={{ paddingRight: 30, paddingLeft: 30 }}>
                <Col span={24} style={{ textAlign: 'center', marginTop: 20, marginBottom: 10 }}>
                    <h1 style={{ fontSize: 34, borderBottom: '2px solid #121f4b', paddingBottom: 10 }}>Most Rated</h1>
                </Col>
            </Row>
            <Row style={{ paddingRight: 30, paddingLeft: 30 }}>
                {
